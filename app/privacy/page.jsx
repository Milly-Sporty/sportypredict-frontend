    ...
    <div className={styles.termsContainer}>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          the SportyPredict website (sportypredict.com) (&apos;the Website&apos;); and (b)
          the SportyPredict mobile application available on app stores (&apos;the
          App&apos;). Together these are referred to as our Services.
        </p>
        <p>
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.bulletList}>
          ...
          <li>
            ...
            handled by the App Store / Play Store; we do not receive payment card
            details from the store. We may receive transaction confirmation and
            subscription identifiers (Transaction ID) from the store so we can
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.bulletList}>
          ...
          <li>
            To improve and personalize content and the user experience (analytics
            and product improvement).
          </li>
          <li>
            To respond to support requests and manage communications.
          </li>
          <li>
            To comply with legal obligations and protect rights and safety (fraud
            prevention, abuse investigations).
          </li>
        </ul>
        <p>
          Legal bases for processing (where applicable and dependent on your
          jurisdiction): contract performance (to deliver services), legitimate
          interests (service improvement, fraud prevention), consent (for
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          our operations (hosting, analytics, email delivery, payment processors,
          customer support, and fraud prevention). These providers process data
          on our behalf under contractual obligations to protect your data.
        </p>
        <p>
          <strong>Important:</strong> For App purchases, the App Store / Play Store
          handles payment processing; please consult the store&apos;s privacy resources
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.bulletList}>
          <li>
            To service providers who help operate the Website (hosting, analytics,
            payment processors).
          </li>
          <li>
      ...
      <div className={styles.section}>
        ...
        <p>
          Data collected via the Website may be processed in jurisdictions outside
          your country (for example, in the country where our service providers
          operate). Where data is transferred internationally, we use appropriate
          safeguards (contractual clauses, security measures) to protect personal
          data.
        </p>
      </div>
      ...
      <div className={styles.section}>
        ...
        <p>
          We retain personal data collected from out website for as long as
          necessary to provide services, comply with legal obligations, resolve
          disputes, enforce our agreements, and for legitimate business purposes.
          Typical retention periods:
        </p>
        <ul className={styles.bulletList}>
          <li>
            Account data: while account is active + 2 years (or as required).
          </li>
          <li>
            Transaction records: up to 7 years for tax and accounting compliance.
          </li>
          <li>
            Analytics and logs: aggregated/anonymized indefinitely; raw logs
            retained for a limited period for security and troubleshooting.
          </li>
        </ul>
        <p>
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.bulletList}>
          <li>
            <strong>Access:</strong> request a copy of personal data held about you.
          </li>
          <li>
          ...
          <li>
            <strong>Deletion:</strong> request deletion of personal data (right to
            be forgotten), subject to legal retention needs.
          </li>
          <li>
          ...
          <li>
            ...
            (e.g., marketing), you may withdraw consent at any time.
          </li>
        </ul>
        <p>
      ...
      <div className={styles.section}>
        <h2>10. How to make a data request or complaint</h2>
        <p>For access, correction, deletion, complaints or other privacy inquiries, contact:</p>
        <p>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          access controls, secure hosting). However, no method of transmission or
          storage is 100% secure. If a data breach occurs that risks user rights,
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          collect personal data from minors. If we learn that we have collected
          personal data from someone under 18 without parental consent, we will
          delete it promptly.
        </p>
      </div>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          While on the mobile app we don&apos;t have any links to third-party sites
          at the moment. This Privacy Policy does not apply to those sites. We
          are not responsible for third-party privacy practices; please review
          their privacy notices before providing personal data.
        </p>
      </div>
      ...
      <div className={styles.section}>
        <h2>17. Additional app store notes (Apple App Store/Google Play Store)</h2>
        <ul className={styles.bulletList}>
          <li>
            The App currently does not collect any data or personal data; the
            App Store / Play Store processes any in-app purchase payments or app
            analytics.
          </li>
          <li>
      ...
      <div className={styles.section}>
        <h2>18. Contact</h2>
        <p>If you have questions about this privacy policy or privacy practices:</p>
        <p>
          Email: <a href="mailto:contact@sportypredict.com">contact@sportypredict.com</a>
        </p>
      </div>
